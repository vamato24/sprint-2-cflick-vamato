...
test("parseCommand incorrect commands", function () {
    expect(function () { main.parseCommandCall("search"); }).toThrow();
});
...
test("csvSearcher Out Of Bounds", function () {
    ...
    expect(function () { main.csvSearcher("-1", "owef"); }).toThrow();
    expect(function () { main.csvSearcher("5", ""); }).toThrow();
    main.csvLoader("/test/dataFive.csv");
    expect(function () { main.csvSearcher("ewiubqwdq", " "); }).toThrow();
    expect(function () { main.csvSearcher("some words", " "); }).toThrow();
    expect(function () { main.csvSearcher("some2words", " "); }).toThrow();
});
...
test("csvSearcher Search by text header", function () {
    ...
    expect(function () { main.csvSearcher("4", "hi"); }).toThrow();
});
test("csvSearcher no data", function () {
    main.csvLoader("/test/dataSix.csv");
    expect(function () { main.csvSearcher("", ""); }).toThrow();
});
